...
const shop = [
  { _id: '324mmmks312',
    ...
    item: [
      ...
      { title: "Арматура А1 гладкая", href: "/shop/armatura/a400c" },
      { title: "Арматура композитная", href: "/shop/armatura/composite" },
      { title: "Арматура А1 катанка", href: "/shop/armatura/katanka" },
    ],
  },
  {
    href: "/shop/truba",
    ...
    title: "Трубы",
    item: [
      { title: "Квадратная", href: "/shop/truba/kvadratnaya" },
      { title: "Прямоугольная", href: "/shop/truba/pryamougolnaya" },
      { title: "Оцинкованная", href: "/shop/truba/ocinkovannaya" },
      { title: "Тонкостенная", href: "/shop/truba/tonkovetsennaya" },
    ],
  },
  {
    icon: "/images/armatura-a3.jpg",
    title: "Трубы",
    item: [
      { title: "Труба ВГП", href: "/shop/truba/vgp" },
      { title: "Оцинкованная", href: "/shop/truba/ocinkovannaya" },
      { title: "Электросварная", href: "/shop/truba/elektrosvarnaya" },
      { title: "Электросварная", href: "/shop/truba/elektrosvarnaya" },
    ],
  },
  {
